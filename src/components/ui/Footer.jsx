        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex w-full md:w-auto relative group">
              ...
              />
              <button
                className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 
              ...
              >
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 opacity-0 
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
            {/* Brand Section with Updated Logo Positioning */}
            <div>
              <div className="mb-6">
                  ...
                  <li key={index}>
                    ...
                    >
                      <span className="relative overflow-hidden">
                        <ChevronRight
                          className="w-4 h-4 transform translate-x-0 group-hover:translate-x-1 
                      ...
                      <span className="relative">
                        {link.name}
                        <span
                          className="absolute left-0 bottom-0 w-full h-px bg-gradient-to-r 
